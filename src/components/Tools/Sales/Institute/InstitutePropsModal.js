...
import styles from './InstitutePropsModal.css';

function InstitutePropsModal(props) {
    ...
    <div className={styles.normal}>
      ...
      >
        <Chart data={data} padding={[20, 20, 95, 20]} forceFit>
          ...
          />
          <Geom type="area" position="CATEGORY*AMT" color="#F04864" />
          <Geom
            type="point" position="CATEGORY*AMT" color="#F04864" shape="circle" size={4}
            style={{ stroke: '#fff',
              lineWidth: 1,
              fillOpacity: 1 }}
          />
...
export default InstitutePropsModal;
